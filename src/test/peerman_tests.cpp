...
{
    std::unique_ptr<PeerManager> peerman = PeerManager::make(0x1338, 0x1338, m_node.connman.get(), *m_node.addrman, *m_node.evictionman, nullptr, *m_node.chainman, *m_node.mempool, *m_node.warnings, {});
